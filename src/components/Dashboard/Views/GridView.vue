<template>
    <div>
        ...
        <div style="width: 280px; height: 30px; margin-left: 15px;">
            <p style="color: #424242; font-family: 'Source Sans Pro'; font-size: 16px; font-weight: bold; font-style: normal; text-decoration: none; text-align: left;">
                Folders
            </p>
        </div>
...
<script>
    ...
    export default {
        ...
        props: ['detailsViewElement', 'recentFiles', 'folders', 'files']
